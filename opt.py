...
def config_parser(cmd=None):
    ...
    parser.add_argument('--model_name', type=str, default='TensorVMSplit',
                        choices=['TensorVMSplit', 'TensorCP', 'TensorTT','TensorVM_Ring','TensorVM' ])
    ...
    parser.add_argument("--lr_init", type=float, default=0.02,
                        help='learning rate')    
    parser.add_argument("--lr_init_plane", type=float, default=0.005,
                        help='learning rate')   
    ...
    parser.add_argument("--L1_weight_rest", type=float, default=0,
                        help='loss weight')
    parser.add_argument("--L2_weight_inital", type=float, default=0.0,
                        help='loss weight')
    parser.add_argument("--L2_weight_rest", type=float, default=0,
                        help='loss weight')
